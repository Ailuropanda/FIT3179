...
The scatter plots were utilised to show the correlation between poverty statistics and crime. Using point as marks as well as a line for the correlation graphs and horizontal position and vertical position for channels.
